...
*/
    ...
    public void addMenuActions(Menu menu) {
        ...
        this.items[2].setIcon(R.drawable.ic_action_eraser);
        ...
        this.items[3].setIcon(R.drawable.ic_action_compass);
