...
public static class ViewHolder extends RecyclerView.ViewHolder {
	...
	public cnvAdapter(String Titles[], int Icons[], String Name, String Email, int Profile){ // MyAdapter Constructor with titles and icons parameter
	...
	@Override
	public void onBindViewHolder(cnvAdapter.ViewHolder holder, int position) {
